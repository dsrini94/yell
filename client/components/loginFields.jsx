...
import {Grid,Input,Checkbox,Button,Divider,Icon,Image} from 'semantic-ui-react';
            ...
            <Grid.Column width ={6}>
              <Grid>
                ...
                <Grid.Row>
                  ...
                  <Grid.Column width={6}>
                    <h3 style={{textAlign:'right',textDecoration: 'underline'}}>Show</h3>
                  </Grid.Column>
                </Grid.Row>
                <Grid.Row>
                  <Grid.Column width={16}>
                ...
                <Grid.Row>
                  ...
                  <Grid.Column width={6}>
                    <h3 style={{textAlign:'right',textDecoration: 'underline'}}>Forgot Password?</h3>
                  </Grid.Column>
                </Grid.Row>
                <Grid.Row>
                  <Grid.Column width={16}>
